...
export default function Login() {
  ...
  return (
    <div className="grid lg:grid-cols-2 min-h-[calc(100vh-130px)] -mx-4">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 text-white relative overflow-hidden rounded-md"
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 font-display font-extrabold text-2xl">
            <img src={logo} alt="TerreMerGn" className="w-12 h-12 rounded-xl object-contain bg-white" />
